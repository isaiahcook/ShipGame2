...
class Board {
    ...
    public void handleUserGuess() {
        ...
        if (row.equals(shipRow)) {
            ...
            System.out.println("You entered an invalid row and/or column, come on now, lets keep it on the board please... row must be between a-j inclusive, columns must be between 0-9 inclusive...");
        }
...
public class Main {
    public static void main(String[] args) {
        ...
        o.msg("... well, at least not in less than 20 guesses which is when i become invisible to you");
        int hits=0;
        int guesses=0;

        Board b = new Board();
        int rowRandom = (int)(Math.random()* 9);
        int columnStartRandom = (int)(Math.random()*4);
        ...
        if (guesses == 20) {
            o.msg("\n\n\nOhhh yeaaaahhhhhh!!!");
            o.msg("I told you that you couldn't find me in less than 20 guesses!!!");
